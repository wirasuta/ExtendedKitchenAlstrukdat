    ...
    while (true){
        ...
        switch (input){
            case 0:
                ...
                break;
            case 1:
                printf("Input T1 dengan diawali input banyaknya elemen\n");
                BacaIsi(&T1);

                printf("Input T2 dengan diakhiri -9999\n");
                BacaIsiTab(&T2);
            ...
            case 7:
                ...
                switch(input){
                case 1:
                    printf("Masukkan elemen yg ingin ditambahkan\n");
                    scanf("%d",&input);
